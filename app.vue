<template>
	...
	>
		<div
			class="flex flex-col md:flex-row justify-center max-w-[1240px] relative md:mt-28"
		>
			...
			>
				...
				<p class="venue-text text-[28px] md:text-[24px]">
					...
					options via the provided link. Please feel free to make a booking, as
					spots are open to the public. However, please note that this does not
					apply to the Luxury Suite.
				</p>
				<p class="venue-small">
	...
	<!-- Map Section alt -->
	<section
		class="bg-[#FAF6F2] flex w-full px-4 py-28 justify-center items-center relative"
	>
		<div class="absolute bg-[#F3EEE7] w-3/5 h-3/4 top-12 right-0"></div>
		<div
			class="max-w-[1240px] flex flex-col md:flex-row w-full h-full justify-between items-stretch gap-20 z-10 relative"
		>
			<div class="flex flex-col justify-between items-start w-full">
				<div class="dream-image">
					<img src="/Price.jpg" alt="" class="w-full" />
				</div>
				<div class="mt-8">
					<p class="location-small">alcoholic</p>
					<h3 class="location-big uppercase">Beverages</h3>
				</div>

				<button
					class="about-submit rounded-full self-end mt-12 md:mt-24"
					@click="downloadPdf"
				>
					Download Pricelist
				</button>
			...
			<div
				class="flex flex-col justify-between items-stretch w-full min-h-full gap-12 md:gap-20"
			>
				<div class="flex justify-between items-end gap-8 h-full">
					<div class="flex flex-col justify-between items-start">
						<p class="location-small">wedding</p>
						<h3 class="location-big uppercase">Location</h3>
					</div>
					<div class="dream-image w-1/2 self-end hidden md:block">
						<img src="/location.png" alt="" class="w-full" />
					</div>
				</div>

				<div class="dream-image w-full h-[400px] md:h-full">
					<iframe
						class="w-full h-full"
						:src="source"
						allowfullscreen
...
const downloadPdf = () => {
	window.open("/Pricelist.pdf", "_blank");
};
</script>
